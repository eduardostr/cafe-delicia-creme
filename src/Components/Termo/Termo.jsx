    ...
    <>
      ...
      <div className={styles.content2}>
        ...
        <ol style={{ marginLeft: '40px' }}>
          ...
          <li>
            <span>
              Além disso, o Café Delícia Creme não garante ou faz qualquer representação relativa à
        ...
        <p>
          <span>
            Estes termos e condições são regidos e interpretados de acordo com as leis do Café
            Delícia e você se submete irrevogavelmente à jurisdição exclusiva dos tribunais naquele
