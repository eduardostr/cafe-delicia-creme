  ...
  return (
    <>
      ...
      <div className={styles.content2}>
        ...
        <p>
          <span>
            O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Café
            Delícia oferece no site e com caráter enunciativo, mas não limitativo:
          </span>
        </p>
        <ul>
          <li>
          ...
          <li>
            <span>
              C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Café
              Delícia, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus
        ...
        <p>
          <span>Esta política é efetiva a partir de&nbsp;28 Fevereiro 2024.</span>
        </p>
        <br />
      </div>
    </>
